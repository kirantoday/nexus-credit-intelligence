...
| Field | Value |
|---|---|
| **Overall Progress** | ~50% — 9 of 18 milestone units complete (16 numbered milestones + 6.5 and 7.5 inserted; 1–7, 6.5, and 7.5 done) |
| **Current Milestone** | Milestone 7.5 — SEC Market Discovery & Automatic Issuer Enrichment (inserted, complete — see below) |
| **Current Status** | Milestone 7.5 is complete. A reusable SEC full-text-search discovery pipeline (`efts.sec.gov`, live-verified) finds distress-relevant issuers Nexus did not previously know about, a shared CIK-first issuer identity resolver resolves them safely, and a provider-agnostic automatic enrichment orchestrator (SEC/CourtListener/OpenFIGI) driven by `issuer_enrichment_status` runs uniformly for newly-discovered and already-known issuers. ADR-020 supersedes ADR-019 to allow strict, signal-hierarchy-based automatic CourtListener docket linking. Execution ran through the planned hard human-approval gate: a 2026-07-01→2026-08-06 live pilot (89 candidates, 1 transient error) was reviewed and approved before the 2026-01-01→2026-08-06 historical backfill (603 candidates, 11 transient errors, identical pipeline) ran. 541 issuers, 6,036 SEC filings, 5,417 evidence records, and 1,856 alerts are now on file from real providers. See `BUILD_LOG.md` for full metrics. |
| **Last Updated** | 2026-08-07 |
| **Current Git Branch** | main |
| **Latest Commit** | (recorded after this update — see `BUILD_LOG.md`) |
